...
<html>
  ...
  <body>
    ...
    <main>
      <form action="http://localhost/src/controller/login.php" method="POST">
      <!-- <form action="http://localhost:8000/src/controller/login.php" method="POST"> -->
        ...
        <br>
        <a href="http://localhost/PHP-Final-Project-Chat/src/controller/redirect.php?page=signup" rel="follow">New user? Sign up!</a> <br>
